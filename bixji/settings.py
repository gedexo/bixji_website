...
WSGI_APPLICATION = 'bixji.wsgi.application'
...
CLOUDLFAIR_TURNSTILE_PUBLIC_KEY = config("CLOUDLFAIR_TURNSTILE_PUBLIC_KEY")
CLOUDLFAIR_TURNSTILE_PRIVATE_KEY = config("CLOUDLFAIR_TURNSTILE_PRIVATE_KEY")