(function ($) {
	...
	=============================================*/
    function makeTimer() {
		var endTime = new Date("20 nov 2026 9:56:00 GMT+01:00");
	...
	var slider = new Swiper('.td-hero-4-zoom', {
		slidesPerView: 1,
		loop: true,
		autoplay: true,
		arrow: false,
	...
	/*=============================================
		=     td-hero-4-slider	   =
	=============================================*/
	var slider = new Swiper('.td-hero-4-slider', {
		slidesPerView: 1,
		spaceBetween: 0,
		loop: true,
		autoplay: {
	...
	/*=============================================
		=     td-testimonial-4-slider	   =
	=============================================*/
	var slider = new Swiper('.td-testimonial-4-slider', {
		slidesPerView: 1,
		spaceBetween: 26,
		loop: true,
		autoplay: {
	...
	/*=============================================
		=     td-hero-5-slider	   =
	=============================================*/
	var slider = new Swiper('.td-hero-5-slider', {
		slidesPerView: 1,
		spaceBetween: 0,
		loop: true,
		autoplay: {
